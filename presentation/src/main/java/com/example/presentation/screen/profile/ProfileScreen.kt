        ...
        when (val currentState = state) {
            ...
            is ProfileState.Data -> {
                Column(
                    ...
                    Text("Мой userId:", style = MaterialTheme.typography.labelMedium)
                    Text(
                        text = currentState.userId.ifBlank { "—" },
                    ...
                    OutlinedButton(
                        onClick = {
                            clipboard.setText(AnnotatedString(currentState.userId))
                        },
                        modifier = Modifier.fillMaxWidth(),
                        enabled = currentState.userId.isNotBlank()
                    ) {
                        Text("Скопировать userId")
                    }
